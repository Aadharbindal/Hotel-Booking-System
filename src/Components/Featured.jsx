...
const Featured = ({hotels}) => {
  ...
  <div className="container mx-auto">
    <div className="text-center mb-12">
      <h2 className="text-4xl lg:text-5xl font-playfair font-bold">Featured Destinations</h2>
      ...
      
      {
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <a href="#" className="border border-gray-300 rounded-md px-4 py-2 text-sm font-semibold hover:bg-gray-100 hover:border-gray-400">Book Now</a>
          </div>
        </div>
      </div>
      )}
